          ...
          <div className = "recipe right">
            ...
            <div className = "recipe steps">
              ...
              <ol className = "recipe list">
                <li>Heat oil in a pan. Sauté onion and garlic. Add the rice and stir-fry for approx. 10 minutes. Add vegetables and stir-fry for approx. 5 minutes. Pour in soy sauce, mix.</li>
